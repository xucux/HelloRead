 ...
 * 上一章快捷键动作
 */
class PreviousChapterAction : AnAction(), DumbAware {
    
    companion object {
        private val logger = LoggerFactory.getLogger(PreviousChapterAction::class.java)
        ...
        try {
            ...
            if (statusBarReadingService.isActive()) {
                ...
                if (HelloReadToolWindow != null) {
                    ...
                    if (readerContent != null) {
                        ...
                        readerComponent?.navigateToPreviousChapter()
                    }
                }
                return
            }
            ...
            if (HelloReadToolWindow != null) {
                ...
                if (readerContent != null) {
                    ...
                    logger.warn("未找到阅读器标签页，无法执行上一章操作")
                }
            }
        } catch (e: Exception) {
            logger.error("执行上一章操作时发生异常", e)
        }
    }
        ...
        if (project != null) {
            try {
                ...
                if (HelloReadToolWindow != null) {
                    ...
                    if (readerContent != null) {
                        val readerComponent = readerContent.component as? com.github.xucux.read.ui.BookReaderToolWindow
                        val canNavigate = readerComponent?.canNavigateToPreviousChapter() ?: false
